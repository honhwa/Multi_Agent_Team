...
def test_legacy_agent_debug_helpers_remain_available_through_shim() -> None:
    ...
    capability_multi_snapshot = legacy._debug_capability_multi_module_snapshot()
    ...
    assert "module_paths" in capability_multi_snapshot
    ...
    assert capability_snapshot["primary_tool_module"] == "workspace_tools"
    assert capability_multi_snapshot["primary_tool_module"] == "workspace_tools"
    assert kernel_host_snapshot["primary_tool_module"]["module_id"] == "workspace_tools"
    assert kernel_host_snapshot["primary_tool_module"]["actual_module_id"] == "codex_core_tools"
